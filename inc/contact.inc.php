...
if ($pageName=="ok") {
    ...
    $writeName          = '<div><label for="Name">Your Name: <span class="star">*</span></label><input class="required" type="text" size="30" name="Name" id="Name" value="" placeholder="Your Name (required)" autofocus required></div>'."\n";
    $writeEmail         = '<div><label for="Sender">Email Address: <span class="star">*</span></label><input class="required email" type="email" size="30" name="Sender" id="Sender" value="" placeholder="Email Address (required)" required></div>'."\n";
    ...
    $writeButtons       = '<div><input type="submit" value="Submit" name="Submit"></div>'."\n";
