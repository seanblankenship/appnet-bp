...
$bad_files = array('_config.php', '_styleguide.php', '404b.php', 'article.php', 'article_list.php', 'article_output.php', 'article_recent.php', 'ar_output.php', 'ar_o_list.php', 'ar_o_list_xml.php', 'calendar.library.php', 'calendar.php', 'details.php', 'email.php', 'emailfriend.php', 'email_rm.php', 'events.inc.php', 'events.vertical.inc.php', 'featured.include.php', 'featured.include.realestate.fade.php', 'featured.land.include.php', 'featured.rental.include.php', 'key_f.php', 'list_events.php', 'member.search.inc.php', 'member_justmap.inc.php', 'member_map.inc.php', 'member_save.php', 'member_tags.inc.php', 'member_view.php', 'ok.php', 'output.php', 'pg_output.php', 'pg_o_list.php', 'pg_o_list_xml.php', 'pg_rss_list.php', 'photo.php', 'photo_list.php', 'photo_output.php', 'photo_recent.php', 'portfolio_featured.php', 'process-quote.php', 'recaptchalib.php', 'register.php', 'result.php', 'rss_list.php', 'sitemap.php', 'sitemap.inc.php', 'test.php', 'test2.php', 'ver.php');
